...
Then in the hierarchical clustering, I also divide those words into five froups. The result is different compared to the K-Means clustering but it still gives us a reasonable classification.
